...
import { Toolbar, Divider, Button, ButtonGroup, CardMedia, Stack, Box } from '@mui/material';
...
export default function Sidebar() {
  ...
  return (
    <nav>
      <Toolbar>
        <CardMedia component="img" image={logo.default} alt="RRStudio logo" sx={{ width: 1 }} />
      </Toolbar>
      <Divider />
